...
CAMPOS_TABELA = {
    ...
    "cnpj": "TEXT",
    "valor_total": "TEXT",
    "valor_mensal_estimado": "TEXT",
    "valor_total_estimado_vigencia": "TEXT",
    "valor_total_materiais_servicos": "TEXT",
    "vigencia": "TEXT",
    "status": "TEXT",
    "risco": "TEXT",
    "score": "INTEGER",
...
def salvar_analise(
    ...
    **kwargs: Any,
    ...
    dados = {
        ...
        "valor_mensal_estimado": _valor(resultado, "valor_mensal_estimado"),
        "valor_total_estimado_vigencia": _valor(resultado, "valor_total_estimado_vigencia"),
        "valor_total_materiais_servicos": _valor(resultado, "valor_total_materiais_servicos"),
