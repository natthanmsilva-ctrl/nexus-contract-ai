...
8. condicao_pagamento_dias deve retornar somente no padrão executivo DD, exemplo: "90DD", "60DD", "30DD" ou "15DD", conforme o contrato. Use somente cláusula financeira de fatura, vencimento ou pagamento da remuneração; não capture prazos operacionais de entrega de informações, relatórios, atendimento ou execução. Não retorne frase longa nesse campo; a explicação completa deve permanecer em forma_pagamento.
